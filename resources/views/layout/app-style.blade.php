...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-sm-block" style="font-family: 'Bebas Neue', sans-serif; font-weight:700;font-style: italic;color:black">SOFTWARE ENGINEERING</span>
      </a>
      <i class="bi bi-list toggle-sidebar-btn"></i>
      
        <a class="user-welcoming nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <hr>
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('datapinjam.index') ? 'active' : '' }}" href="{{ route('datapinjam.index') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed {{-- {{ request()->routeIs('datapinjam.index') ? 'active' : '' }} --}}" href="users-profile.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed {{ request()->routeIs('datapinjam.formpinjam') ? 'active' : '' }}" href="{{ route('datapinjam.formpinjam') }}">
